...
module Refinery
  describe Page, type: :model do
    ...
    before do
      page.parts.new( title: 'body', body: "I'm the first page part for this page.", position: 0 )
      page.parts.new( title: 'side body', body: 'Closely followed by the second page part.', position: 1)
    end
